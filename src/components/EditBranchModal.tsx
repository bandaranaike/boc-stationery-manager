...
import { EditBranchModalProps } from '@/types';

const EditBranchModal: React.FC<EditBranchModalProps> = ({ isOpen, closeModal, branch, onUpdate }) => {
    ...
    const handleUpdate = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        if (branch) {
            await onUpdate({ id: branch.id, name, code });
            closeModal();
        }
    };
